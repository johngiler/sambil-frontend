...
export const metadata = {
  title: "Sambil · Espacios publicitarios",
  description: "Marketplace de espacios publicitarios en centros Sambil.",
};
  ...
  return (
    <html lang="es" className={`${jakarta.variable} ${geistMono.variable} h-full`}>
      <body
        ...
        data-sambil-app="marketplace"
        data-sambil-build="catalog-v2-checkout"
      >
        <Providers>
          <Header />
