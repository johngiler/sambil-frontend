...
/** Carrito marketplace: trazo continuo fino (misma familia visual que el resto del header). */
...
/** Correo (pie de página: junto al valor, no al rótulo). */
...
export function IconPhone({ className = "" }) {
  return (
    ...
    >
      <path
        d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.628 3.102c-.125-.5-.575-.852-1.091-.852H4.125A2.25 2.25 0 0 0 1.875 4.125v2.25z"
        stroke="currentColor"
        strokeWidth={1.5}
        strokeLinecap="round"
        strokeLinejoin="round"
