...
/** Misma estructura que tablas de clientes o usuarios (7 columnas). */
export function ClientesUsuariosSectionSkeleton() {
  return (
    <div className={adminPanelCard}>
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <Skeleton className={`h-11 w-44 ${ROUNDED_CONTROL}`} />
      </div>
