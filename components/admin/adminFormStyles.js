...
export const adminSecondaryBtn =
  "inline-flex items-center justify-center rounded-[15px] border border-zinc-200 bg-white px-4 py-2.5 text-sm font-medium text-zinc-800 shadow-sm hover:bg-zinc-50";
