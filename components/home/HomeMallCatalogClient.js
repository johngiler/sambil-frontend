...
const chipBase =
  "min-h-10 rounded-full border px-3.5 py-2 text-xs font-semibold uppercase tracking-wide transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0c9dcf] focus-visible:ring-offset-2 active:scale-[0.97] sm:min-h-0 sm:py-1.5";
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="min-h-11 w-full rounded-xl border border-zinc-200 bg-zinc-50/80 py-2.5 pl-10 pr-4 text-base text-zinc-900 placeholder:text-zinc-400 transition-[border-color,background-color,box-shadow] duration-200 ease-out focus:border-[#0c9dcf]/50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#0c9dcf]/25 sm:min-h-0 sm:text-sm"
                enterKeyHint="search"
                autoComplete="off"
              />
            </div>
